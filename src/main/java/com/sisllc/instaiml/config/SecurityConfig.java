...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        ...
        return http
            ...
            .pathMatchers("/api/auth/**", "/h2-console/**", "/actuator/**", "/actuator-ui/**",
                "/v3/api-docs/**", "/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/swagger-ui/index.html",
                "/index.html", "/static/**", "/manifest.json", "/favicon.ico",
                "/logo192.png", "/asset-manifest.json", "/service-worker.js")
            .permitAll() // Explicitly permit these static assets
