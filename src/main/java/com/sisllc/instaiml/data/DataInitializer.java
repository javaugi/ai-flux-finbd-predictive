...
public class DataInitializer implements ApplicationRunner{
    ...
    private void initData() {
        ...
        if (dbProps.getSetupMockTestUserOnly()) {
            dataGenService.seedDataTestUserOnly();
        } else {
    ...
    public static final List<String> DDL_TABLES = List.of("testUsers", "patients", "medications", "physicians", "pharmacies",
